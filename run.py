...
val_loader = DataLoader(landmarks_path=cfg.LANDMARKS_DIR, annotations_path=cfg.ANNOTATIONS_DIR,
 mode='validation', batch_size=cfg.BATCH_SIZE, shuffle=True)
...
for epoch in range(cfg.EPOCHS):
    ...
    # Evaluate the model on the validation set, after the epoch
...
torch.save(transformer.state_dict(), cfg.TRANSFORMER_PATH)
torch.save(landmarks_model.state_dict(), cfg.LANDMARKSNN_PATH)